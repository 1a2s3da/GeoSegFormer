"""Train RBP-UNet with SGD + Poly LR (mmsegmentation style).

参考 mmsegmentation 的 PlantSeg baselines 训练配置.
"""
...
def main():
    ...
    ap.add_argument('--proto_warmup', type=int, default=5)
    ap.add_argument('--out_dir', type=str, default=os.path.join(_ROOT, 'runs', 'rbp_v2'))
