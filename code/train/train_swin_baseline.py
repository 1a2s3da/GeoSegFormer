"""Train Swin-T baseline (UNet, no RBP) for ablation."""
...
from models.baseline_swin import BaselineSwin
...
def main():
    ...
    ap.add_argument('--variant', type=str, default='swin_t')
    ap.add_argument('--out_dir', type=str, default=os.path.join(_ROOT, 'runs', 'baseline_swin'))
    ...
    model = BaselineSwin(num_classes=args.num_classes, variant=args.variant,
    ...
    for ep in range(args.epochs):
        ...
        print(f'Ep {ep+1:3d}/{args.epochs} | loss={train_loss:.4f} lr={cur_lr:.5f} '
