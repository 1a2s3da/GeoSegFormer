"""Test eval (with TTA) for Swin baseline."""
...
def main():
    ...
    ap.add_argument('--ckpt', type=str,
                    default=os.path.join(_ROOT, 'runs', 'baseline_swin', 'best.pt'))
    ...
    with open(os.path.join(out_dir, f'{args.split}_results_tta.json'), 'w') as f:
        json.dump(out, f, indent=2)
    print(f'saved: {os.path.join(out_dir, f"{args.split}_results_tta.json")}')
